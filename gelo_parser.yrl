Nonterminals Statements Statement Expression comp math1 math2 assign.
Terminals '+' '-' '*' '/' ';' '=' integer id lt gt function.
...
Expression -> Expression comp Expression : {'$2', '$1', '$3'}.
Expression -> function id Expression : {function, unwrap('$2'), '$3'}.
